...
FM Global was cited alongside [[Chubb]] as one of the two dominant incumbents with deep risk engineering expertise for primary data center insurance. Fraser characterised these firms as housing the senior engineers doing the substantive underwriting work, and suggested they could be a source of talent for a new venture. Dave agreed that risk engineering at the primary level genuinely matters and drives meaningful appetite from carriers.
...
FM Global was cited by both Fraser and Dave as one of the primary carriers with deep risk engineering expertise for large data center campuses. Dave confirmed that risk engineering genuinely matters at the primary layer and that FM Global, alongside [[Chubb]] and [[Zurich]], has meaningful appetite to be in the primary position in order to influence risk mitigation practices. Fraser proposed that a leaner, AI-assisted organization could replicate this capability at a fraction of the cost.
